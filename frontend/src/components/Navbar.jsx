...
const Navbar = ({ toggleSidebar, themeClasses }) => {
  ...
  return (
    <div className={`flex justify-between items-center ${themeClasses.navbar} px-4 py-4 shadow-sm sticky top-0 z-20 md:px-6 h-16 flex-shrink-0`}>
      {/* Left Side */}
      ...
      <div className='flex-1 max-w-xl px-4'>
        <div className={`flex items-center py-2 px-4 gap-2 rounded-full w-full ${
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          {/* Dropdown Menu */}
          {showProfileMenu && (
            <div className={`absolute right-0 mt-2 w-48 py-2 rounded-md shadow-xl border ${themeClasses.navbar} ${themeClasses.borders}`}>
              <div className={`px-4 py-2 border-b md:hidden ${themeClasses.borders}`}>
              ...
              <Link
                to="/profile"
                className={`block px-4 py-2 text-sm ${themeClasses.menuItem.inactive}`}
