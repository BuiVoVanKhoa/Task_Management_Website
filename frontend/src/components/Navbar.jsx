    ...
    >
      ...
      {!isDashboardPage && (
        <div className="flex-1 max-w-xl px-4">
          <div
            className={`flex items-center py-2 px-4 gap-2 rounded-full w-full ${themeClasses.navbar === "bg-gray-900 text-white"
          ...
          >
            {/* Icon tìm kiếm */}
            <MdOutlineSearch
              className={`text-xl ${themeClasses.navbar === "bg-gray-900 text-white"
                  ? "text-gray-400"
                  : "text-gray-500"
                }`}
            />
            ...
            <input
              ...
              placeholder="Search..."
              className={`w-full bg-transparent focus:outline-none text-sm ${themeClasses.navbar === "bg-gray-900 text-white"
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Nút thông báo */}
        <button className={`pt-2 m-2 focus:outline-none ${themeClasses.navbar}`}>
          <NotificationDropdown className="h-6 w-6" />
        </button>
        {/* Menu Profile */}
